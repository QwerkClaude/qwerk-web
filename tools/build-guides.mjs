...
const GUIDE_META = {
  ...
  'que-es-ph-neutro-en-un-shampoo':              { h1:'¿Qué significa que un shampoo tenga pH neutro y por qué importa?', product:{ href:'/automotriz/snow-foam-ph-neutro/', name:'Snow Foam · Espuma pH Neutro' }, wa:'Hola, quiero información del Snow Foam QWERK y sus presentaciones.' },
  'como-usar-snow-foam-en-autolavado':           { h1:'Cómo usar Snow Foam en un autolavado (paso a paso)', product:{ href:'/automotriz/snow-foam-ph-neutro/', name:'Snow Foam · Espuma pH Neutro' }, wa:'Hola, quiero información del Snow Foam QWERK y sus presentaciones.' },
  'limpiar-interiores-sin-sensacion-grasosa':    { h1:'Cómo limpiar interiores de auto sin dejar sensación grasosa', product:{ href:'/automotriz/crema-silicones-interiores/', name:'Crema de Silicones para Interiores' }, wa:'Hola, quiero información de la Crema de Silicones para interiores.' },
