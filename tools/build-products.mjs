...
const META = {
  ...
  'limpiador-textil-alcalino': { cat:'automotriz', code:'ALK 200',    name:'Limpiador Textil Alcalino ALK 200',     img:'/assets/products/alk200.png',  accent:'#e91e8c', price:{low:50,high:600},   pres:'1 L · 5 L · 10 L · 20 L', wa:'Hola, quiero información del limpiador textil ALK 200 y sus diluciones.' },
