...
(function () {
  ...
  var SEL = {
    ...
    ropa: { t: 'Ropa', chips: ['Detergente de alto desempeño', 'Detergente básico para ropa de color', 'Detergente con bicarbonato aroma tipo Zote', 'Detergente con abrillantador de blancos', 'Suavizante de telas', 'Desengrasante textil alcalino', 'Vinagre de limpieza al 8%', 'Reforzador de aroma textil'], p: 'Elige según la necesidad de la carga: alto desempeño, ropa de color, aroma, ropa blanca, suavidad, desengrase o limpieza general.', msg: 'Hola, quiero información y precios de los productos Q-WERK para lavandería.', cat: 'lavanderia' },
